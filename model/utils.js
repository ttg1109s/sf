/*
    model/utils.js — General-purpose utility library: number/array/check/random/calc helpers used across model and controller.
*/
...
export const fb = {
    ...
    number: {
        ...
        round(fltNumber = 0, threadhold = 0.5) {
            ...
            const intNumber = Math.floor(fltNumber);
