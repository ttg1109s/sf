/*
    model/tool.js — Single-tool-use resolver: given a tool + land + player attributes, computes the resulting land/report mutation.
*/
...
export class Tool {
    ...
    #shovel() {
        ...
        this.#landData.slot.cur += (this.#toolData.useEffect + this.#toolData.useEffect * (this.#attr.strength * 2));
    ...
    #seed() {
        ...
        const waterCap = maxWater * 0.7;
        if (setWater > waterCap) setWater = waterCap;
    ...
    #pesticide() {
        ...
        if (fb.check.inRange(this.#landData.pest, 0, 5, false)) {
    ...
    #sickle() {
        ...
        let num = this.#landData.yield + this.#landData.yield * this.#toolData.yieldBuff;
